package com.xinyin.common.interceptor;
...
import com.xinyin.common.annotation.PassToken;
        ...
        if (method.isAnnotationPresent(UserLoginToken.class)) {
            ...
            if (userLoginToken.required()) {
                ...
                try {
                    ...
                    log.error("&&&&&&&&&&&&&&&&&&" + ResultEnum.PERMISSION_JWT_VERIFY_ERROR.getDesc() + ex.getMessage() + "&&&&&&&&&&&&&&");
                    throw new MyException(ResultEnum.PERMISSION_JWT_VERIFY_ERROR.getCode(),
                            ResultEnum.PERMISSION_JWT_VERIFY_ERROR.getDesc());
                }
                return true;
            }
        }
